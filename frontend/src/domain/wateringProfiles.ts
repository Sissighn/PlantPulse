...
} satisfies Record<ProfileType, Record<Season, number>>;

export const PLANT_WATERING_PROFILES: Record<string, WateringProfile> = {
...
export function getPlantProfile(plant?: PlantLike | null) {
